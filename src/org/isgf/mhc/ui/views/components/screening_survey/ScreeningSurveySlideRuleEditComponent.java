...
public class ScreeningSurveySlideRuleEditComponent extends
	...
	protected ScreeningSurveySlideRuleEditComponent() {
		...
		localize(
				storeVariableLabel,
				AdminMessageStrings.SCREENING_SURVEY_SLIDE_RULE_EDITING__STORE_RESULT_TO_VARIABLE);
		localize(
				jumpIfTrueLabel,
	...
	private GridLayout buildJumpLayout() {
		...
		jumpLayout.addComponent(storeVariableLabel, 0, 0);
		...
		storeVariableTextFieldComponent.setWidth("300px");
		storeVariableTextFieldComponent.setHeight("-1px");
		jumpLayout.addComponent(storeVariableTextFieldComponent, 1, 0);
		jumpLayout.setComponentAlignment(storeVariableTextFieldComponent,
				new Alignment(6));
