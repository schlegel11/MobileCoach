...
/**
 * Provides the screening survey slide edit component
 * 
...
public class ScreeningSurveySlideEditComponent extends
	...
	@AutoGenerated
	private MediaObjectIntegrationComponentWithController	mediaObjectIntegrationComponentWithController_1;
	@AutoGenerated
	...
	@AutoGenerated
	private VariableTextFieldComponent						optionalLayoutAttributesTextFieldComponent;
	@AutoGenerated
	private Label											optionalLayoutAttributesLabel;
	@AutoGenerated
	...
	private GridLayout buildSwitchesLayoutGroup() {
		...
		// optionalLayoutAttributesLabel
		optionalLayoutAttributesLabel = new Label();
		optionalLayoutAttributesLabel.setImmediate(false);
		optionalLayoutAttributesLabel.setWidth("-1px");
		optionalLayoutAttributesLabel.setHeight("-1px");
		optionalLayoutAttributesLabel
				.setValue("!!! Optional layout attributes (e.g. CSS classes):");
		switchesLayoutGroup.addComponent(optionalLayoutAttributesLabel, 0, 2);

		// optionalLayoutAttributesTextFieldComponent
		optionalLayoutAttributesTextFieldComponent = new VariableTextFieldComponent();
		optionalLayoutAttributesTextFieldComponent.setImmediate(false);
		optionalLayoutAttributesTextFieldComponent.setWidth("350px");
		optionalLayoutAttributesTextFieldComponent.setHeight("-1px");
		switchesLayoutGroup.addComponent(
				optionalLayoutAttributesTextFieldComponent, 1, 2);
		switchesLayoutGroup.setComponentAlignment(
				optionalLayoutAttributesTextFieldComponent, new Alignment(6));
	...
	private GridLayout buildAdditionalOptionsLayout() {
		...
		// mediaObjectIntegrationComponentWithController_1
		mediaObjectIntegrationComponentWithController_1 = new MediaObjectIntegrationComponentWithController();
		mediaObjectIntegrationComponentWithController_1.setImmediate(false);
		mediaObjectIntegrationComponentWithController_1.setWidth("500px");
		mediaObjectIntegrationComponentWithController_1.setHeight("150px");
		additionalOptionsLayout.addComponent(
				mediaObjectIntegrationComponentWithController_1, 1, 2);
		additionalOptionsLayout.setComponentAlignment(
				mediaObjectIntegrationComponentWithController_1, new Alignment(
						34));
		...
		isLastSlideCheckbox
				.setCaption("!!! Stop scrreening survey after this slide (no rule execution as well)");
