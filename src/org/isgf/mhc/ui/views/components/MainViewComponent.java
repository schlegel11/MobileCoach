...
public class MainViewComponent extends AbstractCustomComponent {
	...
	public MainViewComponent() {
		...
		welcomeButton
				.getButtonLabel()
				.setValue(
						Messages.getAdminString(AdminMessageStrings.MAIN_VIEW__WELCOME_BUTTON));
		interventionsButton.getButtonIcon().setSource(
				new ThemeResource("img/interventions-icon.png"));
		interventionsButton
				.getButtonLabel()
				.setValue(
						Messages.getAdminString(AdminMessageStrings.MAIN_VIEW__INTERVENTIONS_BUTTON));
		accessControlButton.getButtonIcon().setSource(
				new ThemeResource("img/access-control-icon.png"));
		accessControlButton
				.getButtonLabel()
				.setValue(
						Messages.getAdminString(AdminMessageStrings.MAIN_VIEW__ACCESS_CONTROL_BUTTON));
		accountButton.getButtonIcon().setSource(
				new ThemeResource("img/account-icon.png"));
		accountButton
				.getButtonLabel()
				.setValue(
						Messages.getAdminString(AdminMessageStrings.MAIN_VIEW__ACCOUNT_BUTTON));
	}
