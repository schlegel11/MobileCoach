...
/**
 * Provides the monitoring rules edit component
 * 
...
public class MonitoringRulesEditComponent extends AbstractCustomComponent {
	 ...
	 * visual editor.
	 */
	protected MonitoringRulesEditComponent() {
		buildMainLayout();
		...
		localize(
				resultVariableLabel,
				AdminMessageStrings.MONITORING_RULES_EDITING__RESULT_VARIABLE_OF_SELECTED_RULE);
		localize(
				sendMessageLabel,
				AdminMessageStrings.MONITORING_RULES_EDITING__SEND_MESSAGE_AFTER_EXECUTION_OF_SELECTED_RULE);
	...
	private GridLayout buildRulesTreePanelLayout() {
		...
		rulesTreePanelLayout.setHeight("100.0%");
	...
	private VerticalLayout buildRuleDetailsLayout() {
		...
		ruleDetailsLayout.setHeight("-1px");
