...
public class InterventionScreeningSurveysEditComponent extends
	...
	protected InterventionScreeningSurveysEditComponent() {
		...
		localize(
				copyURLButton,
				AdminMessageStrings.INTERVENTION_SCREENING_SURVEY_EDIT_COMPONENT__COPY_URL);
	...
	private HorizontalLayout buildButtonLayout() {
		...
		// copyURLButton
		copyURLButton = new Button();
		copyURLButton.setCaption("!!! Copy URL");
		copyURLButton.setImmediate(true);
		copyURLButton.setWidth("100px");
		copyURLButton.setHeight("-1px");
		buttonLayout.addComponent(copyURLButton);
