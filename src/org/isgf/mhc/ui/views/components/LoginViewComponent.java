...
public class LoginViewComponent extends AbstractCustomComponent {
	...
	public LoginViewComponent() {
		...
		usernameField
				.setCaption(Messages
						.getAdminString(AdminMessageStrings.LOGIN_VIEW__USERNAME_FIELD));
		passwordField
				.setCaption(Messages
						.getAdminString(AdminMessageStrings.LOGIN_VIEW__PASSWORD_FIELD));
		titleLabel.setValue(Messages
				.getAdminString(AdminMessageStrings.APPLICATION__NAME));
		loginButton.setCaption(Messages
				.getAdminString(AdminMessageStrings.LOGIN_VIEW__LOGIN_BUTTON));

		aboutButton.setCaption(Messages
				.getAdminString(AdminMessageStrings.LOGIN_VIEW__ABOUT_LINK));
	...
	private VerticalLayout buildMainLayout() {
		...
		aboutButton.setImmediate(false);
