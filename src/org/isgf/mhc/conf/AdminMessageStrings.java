...
public enum AdminMessageStrings {
	...
	// General
	GENERAL__OK, GENERAL__CANCEL, GENERAL__NEW, GENERAL__ADD, GENERAL__DELETE, GENERAL__REMOVE, GENERAL__IMPORT, GENERAL__EXPORT, GENERAL__RENAME, GENERAL__EDIT, GENERAL__DUPLICATE, GENERAL__RESIZE_ERROR_MESSAGE,
	/*
	 * TABS
	 */
	// Welcome tab
	...
	// UI Columns
	UI_COLUMNS__ACCOUNT, UI_COLUMNS__ACCOUNT_TYPE, UI_COLUMNS__INTERVENTION, UI_COLUMNS__INTERVENTION_STATUS, UI_COLUMNS__MESSAGING_STATUS, UI_COLUMNS__VARIABLE_NAME, UI_COLUMNS__VARIABLE_VALUE;
