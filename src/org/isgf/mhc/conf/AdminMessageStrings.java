...
public enum AdminMessageStrings {
	...
	// General
	GENERAL__OK, GENERAL__CANCEL, GENERAL__NEW, GENERAL__DELETE, GENERAL__IMPORT, GENERAL__EXPORT, GENERAL__EDIT, GENERAL__DUPLICATE, GENERAL__RESIZE_ERROR_MESSAGE,
	/*
	 * TABS
	 */
	// Welcome tab
