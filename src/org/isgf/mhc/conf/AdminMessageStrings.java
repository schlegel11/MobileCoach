...
public enum AdminMessageStrings {
	...
	MONITORING_MESSAGE_EDITING__TEXT_WITH_PLACEHOLDERS, MONITORING_MESSAGE_EDITING__INTEGRATED_MEDIA_OBJECT, MONITORING_MESSAGE_EDITING__STORE_RESULT_TO_VARIABLE, MONITORING_MESSAGE_EDITING__STORE_MESSAGE_REPLY_TO_VARIABLE, MONITORING_RULE_EDITING__STOP_RULE_EXECUTION_AND_FINISH_INTERVENTION_IF_TRUE,
	...
	ABSTRACT_RULE_EDITING__RULE_WITH_PLACEHOLDERS, ABSTRACT_RULE_EDITING__RULE_COMPARISON_TERM_WITH_PLACEHOLDERS,
	...
	SCREENING_SURVEY_SLIDE_EDITING__EDIT_ANSWER, SCREENING_SURVEY_SLIDE_EDITING__EDIT_VALUE, SCREENING_SURVEY_SLIDE_EDITING__TITLE_WITH_PLACEHOLDERS, SCREENING_SURVEY_SLIDE_EDITING__QUESTION_TYPE, SCREENING_SURVEY_SLIDE_EDITING__OPTIONAL_LAYOUT_ATTRIBUTE_WITH_PLACEHOLDERS, SCREENING_SURVEY_SLIDE_EDITING__QUESTION_TEXT, SCREENING_SURVEY_SLIDE_EDITING__PRESELECTED_ANSWER, SCREENING_SURVEY_SLIDE_EDITING__STORE_RESULT_TO_VARIABLE, SCREENING_SURVEY_SLIDE_EDITING__INTEGRATED_MEDIA_OBJECT, SCREENING_SURVEY_SLIDE_EDITING__FINISH_OR_HAND_OVER_TO_FEEDBACK, SCREENING_SURVEY_SLIDE_EDITING__STOP_SCREENING_SURVEY_AFTER_THIS_SLIDE, SCREENING_SURVEY_SLIDE_EDITING__FEEDBACK_TEXT, SCREENING_SURVEY_SLIDE_EDITING__FEEDBACK_INFORMATION_TEXT,
	// Screening survey slide rule editing (also for Feedbacks)
	SCREENING_SURVEY_SLIDE_RULE_EDITING__JUMP_TO_SLIDE_IF_TRUE, SCREENING_SURVEY_SLIDE_RULE_EDITING__JUMP_TO_SLIDE_IF_FALSE, SCREENING_SURVEY_SLIDE_RULE_EDITING__STORE_VALUE_TO_VARIABLE, SCREENING_SURVEY_SLIDE_RULE_EDITING__VALUE_TO_VARIABLE,
	// Intervention participants editing
	INTERVENTION_PARTICIPANTS_EDITING__ASSIGN_ORGANIZATION, INTERVENTION_PARTICIPANTS_EDITING__ASSIGN_UNIT, INTERVENTION_PARTICIPANTS_EDITING__SWITCH_MONITORING, INTERVENTION_PARTICIPANTS_EDITING__SEND_MESSAGE,
	// Intervention basic settings tab
	INTERVENTION_BASIC_SETTINGS_TAB__SWITCH_INTERVENTION_BUTTON_ACTIVE, INTERVENTION_BASIC_SETTINGS_TAB__SWITCH_INTERVENTION_BUTTON_INACTIVE, INTERVENTION_BASIC_SETTINGS_TAB__SWITCH_MONITORING_BUTTON_ACTIVE, INTERVENTION_BASIC_SETTINGS_TAB__SWITCH_MONITORING_BUTTON_INACTIVE,
	// Account tab
	ACCOUNT_TAB__SET_PASSWORD, ACCOUNT_TAB__ACCOUNT_INFORMATION,
	// Simulator component
	SIMULATOR_COMPONENT__SEND_SIMULATED_MESSAGE, SIMULATOR_COMPONENT__JUMP_ONE_HOUR_TO_THE_FUTURE, SIMULATOR_COMPONENT__THE_CURRENT_SIMULATED_TIME_IS_X, SIMULATOR_COMPONENT__SIMULATOR, SIMULATOR_COMPONENT__SYSTEM, SIMULATOR_COMPONENT__PARTICIPANT,
	/*
	 * VIEWS
	 */
	// Login view
	 ...
	 */
	// UI Model
	UI_MODEL__ADMINISTRATOR, UI_MODEL__AUTHOR, UI_MODEL__ACTIVE, UI_MODEL__INACTIVE, UI_MODEL__YES, UI_MODEL__NO, UI_MODEL__NOT_SET, UI_MODEL__UNKNOWN, UI_MODEL__FINISHED, UI_MODEL__NOT_FINISHED, UI_MODEL__EXPECTS_ANSWER, UI_MODEL__EXPECTS_NO_ANSWER,
	// UI Columns
	UI_COLUMNS__ACCOUNT, UI_COLUMNS__ACCOUNT_TYPE, UI_COLUMNS__INTERVENTION, UI_COLUMNS__INTERVENTION_STATUS, UI_COLUMNS__MONITORING_STATUS, UI_COLUMNS__VARIABLE_NAME, UI_COLUMNS__VARIABLE_VALUE, UI_COLUMNS__MESSAGE_TEXT, UI_COLUMNS__HAS_LINKED_MEDIA_OBJECT, UI_COLUMNS__RESULT_VARIABLE, UI_COLUMNS__SCREENING_SURVEY, UI_COLUMNS__SCREENING_SURVEY_PASSWORD, UI_COLUMNS__SCREENING_SURVEY_STATUS, UI_COLUMNS__FEEDBACK, UI_COLUMNS__RULE, UI_COLUMNS__JUMP_TO_SLIDE_WHEN_TRUE, UI_COLUMNS__JUMP_TO_SLIDE_WHEN_FALSE, UI_COLUMNS__SLIDE_TITLE_WITH_PLACEHOLDERS, UI_COLUMNS__QUESTION_TYPE, UI_COLUMNS__ANSWER_WITH_PLACEHODLERS, UI_COLUMNS__VALUE, UI_COLUMNS__PARTICIPANT_NAME, UI_COLUMNS__ORGANIZATION, UI_COLUMNS__ORGANIZATION_UNIT, UI_COLUMNS__CREATED, UI_COLUMNS__SCREENING_SURVEY_NAME, UI_COLUMNS__PARTICIPANT_SCREENING_SURVEY_STATUS, UI_COLUMNS__PARTICIPANT_INTERVENTION_STATUS, UI_COLUMNS__TIMESTAMP, UI_COLUMNS__MESSAGE_TYPE, UI_COLUMNS__PARTICIPANT_ID, UI_COLUMNS__ORDER, UI_COLUMNS__STATUS, UI_COLUMNS__MESSAGE, UI_COLUMNS__SHOULD_BE_SENT_TIMESTAMP, UI_COLUMNS__SENT_TIMESTAMP, UI_COLUMNS__ANSWER, UI_COLUMNS__ANSWER_RECEIVED_TIMESTAMP, UI_COLUMNS__MANUALLY_SENT, UI_COLUMNS__MEDIA_CONTENT_VIEWED, UI_COLUMNS__VARIABLE, UI_COLUMNS__PARTICIPANT_DATA_FOR_MONITORING_AVAILABLE, UI_COLUMNS__CONTAINS_RULES, UI_COLUMNS__RAW_ANSWER,
	/*
	 * MODULES
	 */
	// General
	...
	// Quiz
	MODULES__QUIZ__NAME, MODULES__QUIZ__SELECT_RELEVANT_MESSAGE, MODULES__QUIZ__FOLLOWING_MESSAGES_SENT_TO_PARTICIPANTS, MODULES__QUIZ__SEND_MESSAGE_TO_SELECTED_PARTICIPANTS;
