...
public enum AdminMessageStrings {
	...
	// General
	GENERAL__OK, GENERAL__CANCEL, GENERAL__NEW, GENERAL__DELETE, GENERAL__IMPORT, GENERAL__EXPORT, GENERAL__RENAME, GENERAL__EDIT, GENERAL__DUPLICATE, GENERAL__RESIZE_ERROR_MESSAGE,
	/*
	 * TABS
	 */
	// Welcome tab
	...
	INTERVENTION_EDITING_CONTAINER__LIST_ALL_INTERVENTIONS_BUTTON, INTERVENTION_EDITING_CONTAINER__INTERVENTIONS_TITLE, INTERVENTION_EDITING_CONTAINER__BASIC_SETTINGS_TAB,
	...
	ABSTRACT_STRING_EDITOR_WINDOW__SET_PASSWORD, ABSTRACT_STRING_EDITOR_WINDOW__ENTER_USERNAME_FOR_NEW_USER, ABSTRACT_STRING_EDITOR_WINDOW__ENTER_NAME_FOR_NEW_INTERVENTION, ABSTRACT_STRING_EDITOR_WINDOW__ENTER_NEW_NAME_FOR_INTERVENTION,
	 ...
	 */
	// Notifications
	NOTIFICATION__UNKNOWN_ERROR, NOTIFICATION__WRONG_LOGIN, NOTIFICATION__NO_VALID_USERNAME, NOTIFICATION__NO_VALID_PASSWORD, NOTIFICATION__DEFAULT_ADMIN_CANT_BE_SET_AS_AUTHOR, NOTIFICATION__CANT_DELETE_YOURSELF, NOTIFICATION__DEFAULT_ADMIN_CANT_BE_DELETED, NOTIFICATION__PASSWORD_CHANGED, NOTIFICATION__THE_GIVEN_PASSWORD_IS_NOT_SAFE, NOTIFICATION__ACCOUNT_CHANGED_TO_ADMIN, NOTIFICATION__ACCOUNT_CHANGED_TO_AUTHOR, NOTIFICATION__ACCOUNT_DELETED, NOTIFICATION__ACCOUNT_CREATED, NOTIFICATION__THE_GIVEN_USERNAME_IS_TOO_SHORT, NOTIFICATION__THE_GIVEN_USERNAME_IS_ALREADY_IN_USE, NOTIFICATION__INTERVENTION_CREATED, NOTIFICATION__INTERVENTION_DELETED, NOTIFICATION__INTERVENTION_RENAMED,
	 ...
	 */
	// UI Model
	UI_MODEL__ADMINISTRATOR, UI_MODEL__AUTHOR, UI_MODEL__ACTIVE, UI_MODEL__INACTIVE,
	// UI Columns
	UI_COLUMNS__ACCOUNT, UI_COLUMNS__ACCOUNT_TYPE, UI_COLUMNS__INTERVENTION, UI_COLUMNS__INTERVENTION_STATUS, UI_COLUMNS__MESSAGING_STATUS;
