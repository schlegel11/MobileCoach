...
public class ScreeningSurveySlideRuleEditComponent extends
	...
	private GridLayout buildJumpLayout() {
		...
		jumpLayout.addComponent(jumpIfTrueLabel, 0, 0);
		...
		jumpLayout.addComponent(jumpIfTrueComboBox, 1, 0);
		...
		jumpLayout.addComponent(jumpIfFalseLabel, 0, 1);
		...
		jumpLayout.addComponent(jumpIfFalseComboBox, 1, 1);
		jumpLayout
