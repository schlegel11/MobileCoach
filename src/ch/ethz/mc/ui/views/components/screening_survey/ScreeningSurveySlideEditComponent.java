...
public class ScreeningSurveySlideEditComponent extends
	...
	private HorizontalLayout buildQuestionsLayout() {
		...
		questionsLayout.setExpandRatio(questionsFlowLayout, 0.86f);
	...
	private VerticalLayout buildQuestionsTableLayout() {
		...
		questionsTable.setWidth("100px");
		questionsTable.setHeight("210px");
		...
		newQuestionButton.setWidth("100px");
		...
		deleteQuestionButton.setWidth("100px");
