...
public class MainViewComponent extends AbstractCustomComponent {
	...
	@AutoGenerated
	private MenuButtonComponent	conversationsButton;
	@AutoGenerated
	private MenuButtonComponent	integrationsButton;
	@AutoGenerated
	...
	public MainViewComponent() {
		...
		integrationsButton.getButtonIcon().setSource(
				new ThemeResource("img/interventions-icon.png"));
		...
		localize(conversationsButton.getButtonLabel(),
				AdminMessageStrings.MAIN_VIEW__CONVERSATIONS_BUTTON);
		localize(integrationsButton.getButtonLabel(),
				AdminMessageStrings.MAIN_VIEW__INTEGRATIONS_BUTTON);
	...
	private VerticalLayout buildMenuPanelLayout() {
		...
		titleLabel.setValue("!!! Mobile Coach");
	...
	private VerticalLayout buildMenuButtonsLayout() {
		...
		// conversationsButton
		conversationsButton = new MenuButtonComponent();
		conversationsButton.setImmediate(false);
		conversationsButton.setWidth("100.0%");
		conversationsButton.setHeight("80px");
		menuButtonsLayout.addComponent(conversationsButton);
		menuButtonsLayout.setComponentAlignment(conversationsButton,
				new Alignment(20));
		
		// integrationsButton
		integrationsButton = new MenuButtonComponent();
		integrationsButton.setImmediate(false);
		integrationsButton.setWidth("100.0%");
		integrationsButton.setHeight("80px");
		menuButtonsLayout.addComponent(integrationsButton);
		menuButtonsLayout.setComponentAlignment(integrationsButton,
				new Alignment(20));
