...
public class MonitoringRuleEditComponent extends AbstractClosableEditComponent {
	...
	@AutoGenerated
	private CheckBox										sendOutsideOfAppComboBox;
	...
	protected MonitoringRuleEditComponent() {
		...
		sendOutsideOfAppComboBox.setImmediate(true);
	...
	private VerticalLayout buildSwitchesGroupLayout() {
		...
		// sendToSupervisorComboBox
		sendOutsideOfAppComboBox = new CheckBox();
		sendOutsideOfAppComboBox.setStyleName("bold");
		sendOutsideOfAppComboBox.setCaption("Enforce sending using Email or SMS");
		sendOutsideOfAppComboBox.setImmediate(false);
		sendOutsideOfAppComboBox.setWidth("100.0%");
		sendOutsideOfAppComboBox.setHeight("-1px");
		switchesGroupLayout.addComponent(sendOutsideOfAppComboBox);
