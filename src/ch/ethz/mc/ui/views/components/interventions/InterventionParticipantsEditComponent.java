...
AbstractCustomComponent {
	...
	@AutoGenerated
	private Button				regenerateOneTimeTokenButton;
	@AutoGenerated
	...
	protected InterventionParticipantsEditComponent() {
		...
		localize(regenerateOneTimeTokenButton, 
				AdminMessageStrings.INTERVENTION_PARTICIPANTS_EDITING__REGENERATE_ONE_TIME_TOKEN);
	...
	public void updateButtonStatus(
		...
		if (selectedUIParticipantsIds == null
			...
			regenerateOneTimeTokenButton.setEnabled(true);
		}
	}
	...
	protected void setNothingSelected() {
		...
		regenerateOneTimeTokenButton.setEnabled(false);
	}
	...
	private HorizontalLayout buildButtonLayout2() {
		...
		// regenerateOneTimeTokenButton
		regenerateOneTimeTokenButton = new Button();
		regenerateOneTimeTokenButton.setCaption("!!! Re-generate One-Time Token");
		regenerateOneTimeTokenButton.setIcon(new ThemeResource(
				"img/loading-icon-small.png"));
		regenerateOneTimeTokenButton.setImmediate(true);
		regenerateOneTimeTokenButton.setWidth("200px");
		regenerateOneTimeTokenButton.setHeight("-1px");
		buttonLayout2.addComponent(regenerateOneTimeTokenButton);
