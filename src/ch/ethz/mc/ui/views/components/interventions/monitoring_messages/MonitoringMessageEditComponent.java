...
public class MonitoringMessageEditComponent extends
	...
	private VerticalLayout buildMainLayout() {
		...
		isCommandCheckbox
				.setCaption("!!! This message is a command (invisible for participant)");
	...
	private GridLayout buildGridLayout() {
		...
		gridLayout.addComponent(intermediateSurveyLabel, 0, 2);
		...
		gridLayout.addComponent(intermediateSurveyComboBox, 1, 2);
		gridLayout.setComponentAlignment(intermediateSurveyComboBox,
				new Alignment(34));
		...
		gridLayout.addComponent(storeVariableLabel, 0, 3);
		...
		gridLayout.addComponent(storeVariableTextFieldComponent, 1, 3);
