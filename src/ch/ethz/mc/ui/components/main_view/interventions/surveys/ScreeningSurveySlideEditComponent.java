...
public class ScreeningSurveySlideEditComponent
	...
	@AutoGenerated
	private ComboBox										provideExternalIdDialologOptionAccessDataComboBox;
	@AutoGenerated
	private Label											provideExternalIdDialologOptionAccessDataLabel;
	@AutoGenerated
	...
	protected ScreeningSurveySlideEditComponent() {
		...
		localize(provideExternalIdDialologOptionAccessDataLabel,
				AdminMessageStrings.SCREENING_SURVEY_SLIDE_EDITING__PROVIDE_EXTERNAL_ID_ACCESS_DATA);
		...
		provideExternalIdDialologOptionAccessDataComboBox.setImmediate(true);
		provideExternalIdDialologOptionAccessDataComboBox
	...
	private GridLayout buildSwitchesLayoutGroup() {
		...
		titleWithPlaceholdersTextFieldComponent.setWidth("500px");
		...
		commentTextFieldComponent.setWidth("500px");
		...
		questionTypeComboBox.setWidth("500px");
		...
		optionalLayoutAttributeTextFieldComponent.setWidth("500px");
	...
	private VerticalLayout buildQuestionsTableLayout() {
		...
		newQuestionButton.setWidth("160px");
		...
		duplicateQuestionButton.setWidth("160px");
		...
		deleteQuestionButton.setWidth("160px");
	...
	private GridLayout buildQuestionTextLayout() {
		...
		questionTextWithPlaceholdersTextField.setWidth("500px");
	...
	private GridLayout buildAdditionalOptionsLayout() {
		...
		additionalOptionsLayout.setRows(6);
		...
		intermediateSurveyLabel.setValue("!!! Link intermediate survey:");
		additionalOptionsLayout.addComponent(intermediateSurveyLabel, 0, 2);
		...
		additionalOptionsLayout.addComponent(intermediateSurveyComboBox, 1, 2);
		additionalOptionsLayout.setComponentAlignment(
				intermediateSurveyComboBox, new Alignment(34));

		// provideExternalIdDialologOptionAccessDataLabel
		provideExternalIdDialologOptionAccessDataLabel = new Label();
		provideExternalIdDialologOptionAccessDataLabel.setImmediate(false);
		provideExternalIdDialologOptionAccessDataLabel.setWidth("-1px");
		provideExternalIdDialologOptionAccessDataLabel.setHeight("-1px");
		provideExternalIdDialologOptionAccessDataLabel.setValue(
				"!!! Provide external access data for selected service:");
		additionalOptionsLayout.addComponent(
				provideExternalIdDialologOptionAccessDataLabel, 0, 3);

		// provideExternalIdDialologOptionAccessDataComboBox
		provideExternalIdDialologOptionAccessDataComboBox = new ComboBox();
		provideExternalIdDialologOptionAccessDataComboBox.setImmediate(false);
		provideExternalIdDialologOptionAccessDataComboBox.setWidth("500px");
		provideExternalIdDialologOptionAccessDataComboBox.setHeight("-1px");
		additionalOptionsLayout.addComponent(
				provideExternalIdDialologOptionAccessDataComboBox, 1, 3);
		additionalOptionsLayout.setComponentAlignment(
				provideExternalIdDialologOptionAccessDataComboBox,
				new Alignment(34));
		...
		additionalOptionsLayout.addComponent(feedbackLabel, 0, 4);
		...
		additionalOptionsLayout.addComponent(isLastSlideCheckbox, 1, 4);
		...
		additionalOptionsLayout.addComponent(feedbackComboBox, 1, 5);
