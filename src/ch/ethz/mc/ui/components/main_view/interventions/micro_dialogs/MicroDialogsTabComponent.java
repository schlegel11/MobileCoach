...
public abstract class MicroDialogsTabComponent extends AbstractCustomComponent {
	...
	@AutoGenerated
	private Button				duplicateDialogButton;
	@AutoGenerated
	...
	protected MicroDialogsTabComponent() {
		...
		localize(duplicateDialogButton,
				AdminMessageStrings.MICRO_DIALOG_EDITING__DUPLICATE_DIALOG);
	...
	protected void setNothingSelected() {
		...
		duplicateDialogButton.setEnabled(false);
	...
	protected void setSomethingSelected() {
		...
		duplicateDialogButton.setEnabled(true);
	...
	public Tab addTabComponent(final MicroDialog microDialog,
		...
		// Add edit component to tab
		val tab = microDialogsTabSheet.addTab(microDialogEditComponent,
				microDialog.getName(), null);
		((MicroDialogEditComponentWithController) microDialogEditComponent)
				.setTab(tab);
	...
	private HorizontalLayout buildButtonLayout() {
		...
		duplicateDialogButton = new Button();
		duplicateDialogButton.setCaption("!!! Duplicate Dialog");
		duplicateDialogButton.setImmediate(true);
		duplicateDialogButton.setWidth("120px");
		duplicateDialogButton.setHeight("-1px");
		buttonLayout.addComponent(duplicateDialogButton);
