...
public class MicroDialogEditComponent extends AbstractCustomComponent {
	...
	protected MicroDialogEditComponent() {
		...
		localize(commentLabel,
				AdminMessageStrings.MICRO_DIALOG_EDITING__COMMENT);
	...
	@AutoGenerated
	private GridLayout buildTopLayout() {
		// common part: create layout
		...
		topLayout.addComponent(commentLabel, 0, 0);
		...
		topLayout.addComponent(commentTextFieldComponent, 1, 0);
		topLayout.setComponentAlignment(commentTextFieldComponent,
				new Alignment(6));
	...
	private HorizontalLayout buildButtonLayout() {
		...
		copyButton.setCaption(" ");
		copyButton.setIcon(new ThemeResource("img/copy-icon-small.png"));
		copyButton.setImmediate(true);
		copyButton.setWidth("55px");
		copyButton.setHeight("-1px");
		buttonLayout.addComponent(copyButton);

		// pasteButton
		pasteButton = new Button();
		pasteButton.setCaption(" ");
		pasteButton.setIcon(new ThemeResource("img/paste-icon-small.png"));
		pasteButton.setImmediate(true);
		pasteButton.setWidth("55px");
		pasteButton.setHeight("-1px");
		buttonLayout.addComponent(pasteButton);
