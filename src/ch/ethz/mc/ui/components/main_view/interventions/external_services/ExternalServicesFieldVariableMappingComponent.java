...
public class ExternalServicesFieldVariableMappingComponent extends AbstractClosableEditComponent{
	...
	protected ExternalServicesFieldVariableMappingComponent() {
		buildMainLayout();
