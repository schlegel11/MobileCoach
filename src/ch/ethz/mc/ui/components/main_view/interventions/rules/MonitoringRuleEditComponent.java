...
public class MonitoringRuleEditComponent extends AbstractClosableEditComponent {
	...
	@AutoGenerated
	private ComboBox										decimalHourVariableToSendMessageComboBox;
	...
	protected MonitoringRuleEditComponent() {
		...
		decimalHourVariableToSendMessageComboBox.setImmediate(true);
		decimalHourVariableToSendMessageComboBox.setNullSelectionAllowed(true);
		decimalHourVariableToSendMessageComboBox.setTextInputAllowed(false);
	}
	...
	private GridLayout buildGridLayout2() {
		...
		gridLayout2.setComponentAlignment(messageGroupLabel, new Alignment(33));
		...
		gridLayout2.setComponentAlignment(microDialogLabel, new Alignment(33));
		...
		gridLayout2.addComponent(hourToSendMessageLabel, 0, 2);

		// horizontalLayout_2
		horizontalLayout_2 = buildHorizontalLayout_2();
		gridLayout2.addComponent(horizontalLayout_2, 1, 2);
		gridLayout2.setComponentAlignment(horizontalLayout_2,
				new Alignment(34));
		...
		gridLayout2.addComponent(minutesUntilHandledAsNotAnsweredLabel, 0, 3);

		// horizontalLayout_1
		horizontalLayout_1 = buildHorizontalLayout_1();
		gridLayout2.addComponent(horizontalLayout_1, 1, 3);
		gridLayout2.setComponentAlignment(horizontalLayout_1,
				new Alignment(34));
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		decimalHourVariableToSendMessageComboBox = new ComboBox();
		decimalHourVariableToSendMessageComboBox.setImmediate(false);
		decimalHourVariableToSendMessageComboBox.setWidth("230px");
		decimalHourVariableToSendMessageComboBox.setHeight("-1px");
		horizontalLayout_2
				.addComponent(decimalHourVariableToSendMessageComboBox);
		horizontalLayout_2.setComponentAlignment(
				decimalHourVariableToSendMessageComboBox, new Alignment(33));

		// hourToSendMessageSlider
		hourToSendMessageSlider = new Slider();
		hourToSendMessageSlider.setImmediate(false);
		hourToSendMessageSlider.setWidth("150px");
		hourToSendMessageSlider.setHeight("-1px");
		horizontalLayout_2.addComponent(hourToSendMessageSlider);
		horizontalLayout_2.setComponentAlignment(hourToSendMessageSlider,
				new Alignment(34));
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		horizontalLayout_1.setWidth("400px");
