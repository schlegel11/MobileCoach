...
public class MicroDialogMessageEditComponent
	...
	@AutoGenerated
	private CheckBox										answerCanBeCancelledCheckBox;
	...
	protected MicroDialogMessageEditComponent() {
		...
		localize(answerCanBeCancelledCheckBox,
				AdminMessageStrings.MICRO_DIALOG_MESSAGE_EDITING__ANSWER_CAN_BE_CANCELLED);
		...
		answerCanBeCancelledCheckBox.setImmediate(true);
	}
	...
	private VerticalLayout buildMainLayout() {
		...
		answerCanBeCancelledCheckBox = new CheckBox();
		answerCanBeCancelledCheckBox
				.setCaption("!!! This message’s answer can be cancelled");
		answerCanBeCancelledCheckBox.setImmediate(false);
		answerCanBeCancelledCheckBox.setWidth("100.0%");
		answerCanBeCancelledCheckBox.setHeight("-1px");
		mainLayout.addComponent(answerCanBeCancelledCheckBox);
