...
public class MonitoringMessageEditComponent
	...
	@AutoGenerated
	private CheckBox										isPushOnlyCheckbox;
	...
	protected MonitoringMessageEditComponent() {
		...
		localize(isPushOnlyCheckbox,
				AdminMessageStrings.MONITORING_MESSAGE_EDITING__MESSAGE_IS_PUSH_ONLY);
		...
		isPushOnlyCheckbox.setImmediate(true);
	}
	...
	private VerticalLayout buildMainLayout() {
		...
		// isPushOnlyCheckbox
		isPushOnlyCheckbox = new CheckBox();
		isPushOnlyCheckbox.setCaption(
				"!!! This message will only be sent as push notification and NOT appear in the chat");
		isPushOnlyCheckbox.setImmediate(false);
		isPushOnlyCheckbox.setWidth("100.0%");
		isPushOnlyCheckbox.setHeight("-1px");
		mainLayout.addComponent(isPushOnlyCheckbox);
