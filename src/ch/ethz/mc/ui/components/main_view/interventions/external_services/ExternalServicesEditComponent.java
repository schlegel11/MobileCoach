...
public class ExternalServicesEditComponent extends AbstractCustomComponent {
	...
	@AutoGenerated
	private TextArea			serviceLoginJsonTextArea;
	@AutoGenerated
	private TextArea			serviceLoginHttpAuthTextArea;
	@AutoGenerated
	private TextArea			serviceExternalMessageJsonTextArea;
	...
	protected ExternalServicesEditComponent() {
		...
		localize(fieldVariableMappingButton,
				AdminMessageStrings.INTERVENTION_EXTERNAL_SERVICES_EDITING__FIELD_VARIABLE_MAPPING_BUTTON);
		localize(serviceLoginJsonTextArea,
				AdminMessageStrings.INTERVENTION_EXTERNAL_SERVICES_EDITING__SERVICE_LOGIN_JSON_TEXT_AREA);
		localize(serviceLoginHttpAuthTextArea,
				AdminMessageStrings.INTERVENTION_EXTERNAL_SERVICES_EDITING__SERVICE_LOGIN_HTTP_AUTH_TEXT_AREA);
		localize(serviceExternalMessageJsonTextArea,
				AdminMessageStrings.INTERVENTION_EXTERNAL_SERVICES_EDITING__SERVICE_EXTERNAL_MESSAGE_JSON_TEXT_AREA);
	...
	protected void setNothingSelected() {
		...
		serviceLoginJsonTextArea.setEnabled(false);
		serviceLoginJsonTextArea.setReadOnly(false);
		serviceLoginJsonTextArea.clear();
		serviceLoginJsonTextArea.setReadOnly(true);
		
		serviceLoginHttpAuthTextArea.setEnabled(false);
		serviceLoginHttpAuthTextArea.setReadOnly(false);
		serviceLoginHttpAuthTextArea.clear();
		serviceLoginHttpAuthTextArea.setReadOnly(true);
		
		serviceExternalMessageJsonTextArea.setEnabled(false);
		serviceExternalMessageJsonTextArea.setReadOnly(false);
		serviceExternalMessageJsonTextArea.clear();
		serviceExternalMessageJsonTextArea.setReadOnly(true);
	}
	...
	protected void setSomethingSelected() {
		...
		serviceLoginJsonTextArea.setEnabled(true);
		serviceLoginHttpAuthTextArea.setEnabled(true);
		serviceExternalMessageJsonTextArea.setEnabled(true);
	}
	
	protected void setLoginJsonTextAreaContent(JsonObject jsonObject) {
		serviceLoginJsonTextArea.setReadOnly(false);
		serviceLoginJsonTextArea.setValue(StringHelpers.createPrettyPrintedJSON(jsonObject));
		serviceLoginJsonTextArea.setReadOnly(true);
	}
	...
	protected void setLoginHttpAuthTextAreaContent(int clientVersion,
		...
		serviceLoginHttpAuthTextArea.setReadOnly(false);
		serviceLoginHttpAuthTextArea.setValue("'token' => '"
	...
	protected void setExternalMessageJsonTextAreaContent(JsonObject jsonObject) {
		serviceExternalMessageJsonTextArea.setReadOnly(false);
		serviceExternalMessageJsonTextArea.setValue(StringHelpers.createPrettyPrintedJSON(jsonObject));
		serviceExternalMessageJsonTextArea.setReadOnly(true);
	}
	...
	private VerticalLayout buildTextAreaLayout() {
		...
		serviceLoginJsonTextArea = new TextArea();
		serviceLoginJsonTextArea.setCaption("!!! Service login JSON Output");
		serviceLoginJsonTextArea.setWidth("100.0%");
		serviceLoginJsonTextArea.setHeight("-1px");
		serviceLoginJsonTextArea.setImmediate(true);
		serviceLoginJsonTextArea.setReadOnly(true);
		textAreaLayout.addComponent(serviceLoginJsonTextArea);
		
		// serviceLoginHttpAuthTextArea
		serviceLoginHttpAuthTextArea = new TextArea();
		serviceLoginHttpAuthTextArea.setCaption("!!! Service login HTTP auth Output");
		serviceLoginHttpAuthTextArea.setWidth("100.0%");
		serviceLoginHttpAuthTextArea.setHeight("-1px");
		serviceLoginHttpAuthTextArea.setImmediate(true);
		serviceLoginHttpAuthTextArea.setReadOnly(true);
		textAreaLayout.addComponent(serviceLoginHttpAuthTextArea);
		
		// serviceExternalMessageJsonTextArea
		serviceExternalMessageJsonTextArea = new TextArea();
		serviceExternalMessageJsonTextArea.setCaption("!!! Service message Output");
		serviceExternalMessageJsonTextArea.setWidth("100.0%");
		serviceExternalMessageJsonTextArea.setHeight("-1px");
		serviceExternalMessageJsonTextArea.setImmediate(true);
		serviceExternalMessageJsonTextArea.setReadOnly(true);
		textAreaLayout.addComponent(serviceExternalMessageJsonTextArea);
