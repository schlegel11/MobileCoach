 ...
 * {@link MicroDialogMessageRule}s
 * return true a specific {@link MicroDialogMessage} is send.
 *
...
public class MicroDialogMessageRule extends AbstractRule {
	...
	/**
	 * The position of the {@link MicroDialogMessageRule} compared to all
	 * other {@link MicroDialogMessageRule}s; the first rule will be called
	 * first
	 */
	@Getter
	@Setter
