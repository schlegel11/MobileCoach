...
public enum GeneralSlideTemplateFieldTypes {
	...
	REST_API_URL,
	/**
	 * Contains the base URL of uploaded media contents
	 */
	UPLOADED_MEDIA_CONTENT_URL,
	/**
	...
	/**
	 * Contains the language of the current participant
	 */
	LANGUAGE,
	/**
	 * Contains the group of the current participant
	 */
	GROUP,
	/**
